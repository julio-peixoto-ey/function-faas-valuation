...
from .model import TokenUsage, TokenSummary, CostBreakdown
...
class TokenCounter:
    ...
    def log_embedding_usage(self, texts: List[str]) -> int:
        ...
        logging.info(f"Embedding - {len(texts)} documents, {total_tokens} tokens")
        return total_tokens
    ...
    def get_summary(self) -> TokenSummary:
        ...
        logging.info(f"RESUMO DE TOKENS: {summary.to_dict()}")
        return summary
